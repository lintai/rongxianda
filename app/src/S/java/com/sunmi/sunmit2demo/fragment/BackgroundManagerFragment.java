...
public class BackgroundManagerFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void add() {
        ...
        if (TextUtils.isEmpty(url)) {
            GoodsCode.getInstance().addToDb(id, R.drawable.ic_launcher, name, Float.parseFloat(price), num, unit, GoodsCode.MODE_5);

        } else {
            GoodsCode.getInstance().addToDb(id, url, name, Float.parseFloat(price), num, unit, GoodsCode.MODE_5);
        }
    }
